...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: 'reporting/warehouse-sync', name: 'WarehouseSync', component: () => import('@/pages/WarehouseSyncPage.vue'), meta: { roles: [ROLES.ADMIN, 'analyst'] } },
      { path: 'reporting/inventory', name: 'InventoryAnalytics', component: () => import('@/pages/WarehouseInventoryPage.vue'), meta: { roles: [ROLES.ADMIN, 'analyst'] } },
      { path: 'reporting/stock-position', name: 'StockPosition', component: () => import('@/pages/WarehouseStockPositionPage.vue'), meta: { roles: [ROLES.ADMIN, 'analyst'] } },
      ...
      { path: 'pos/yield',          name: 'PosYield',      component: () => import('@/pages/YieldPage.vue'), meta: { roles: [ROLES.ADMIN, SHOP_ADMIN_ROLE] } },
