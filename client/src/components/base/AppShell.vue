    ...
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <details v-if="canViewDispatch" class="nav-section" :open="navOpen.dispatch" @toggle="onNavToggle('dispatch', $event)">
          ...
          <RouterLink v-if="canDispAssemble" to="/dispatch/assembly" class="nav-item" active-class="active" @click="closeSidebarOnMobile">
            <i class="pi pi-box" />
            <span>Assembly</span>
          </RouterLink>
          ...
          <RouterLink v-if="canDispLoad" to="/dispatch/loading" class="nav-item" active-class="active" @click="closeSidebarOnMobile">
            <i class="pi pi-truck" />
            <span>Loading</span>
          </RouterLink>
        </details>
...
import { canAccessDispatch, canDispatchRegistry, canDispatchAssign, canDispatchAssemble, canDispatchPack, canDispatchLoad } from '@/lib/dispatchAccess.js'
...
const canDispLoad     = computed(() => canDispatchLoad(role.value))
