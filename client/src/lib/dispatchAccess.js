...
export const DISPATCH_ROLES = ['admin', 'dispatch-supervisor', 'dispatch-registry', 'assembler', 'packer', 'checker', 'loader', 'chiller-attendant']
...
export const canDispatchAssemble  = (role) => has(['admin', 'dispatch-supervisor', 'assembler', 'packer'], role)
