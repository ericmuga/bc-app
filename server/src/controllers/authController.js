...
export async function createUser(req, res) {
  ...
  const VALID_ROLES = [ROLES.ADMIN, ROLES.SALES, ROLES.DISPATCH, ROLES.SECURITY, ROLES.ANALYST, ROLES.DATA_ANALYST, ROLES.SHOP, ROLES.SHOP_ADMIN, ROLES.SALES_ADMIN, ROLES.CHEF, ROLES.FINANCE, ROLES.COSTING, ROLES.PRODUCTION, ROLES.DISPATCH_REGISTRY, ROLES.DISPATCH_SUPERVISOR, ROLES.PACKER, ROLES.CHECKER, ROLES.LOADER];
