      ...
      schemas: {
        ...
        SalesLine: {
          ...
          properties: {
            ...
            LineAmount:    { type: 'number', example: 4800 },
          ...
          properties: {
            header: {
              ...
              properties: {
                ...
                salespersonCode: { type: 'string', example: 'SP001' },
                routeCode:       { type: 'string', example: 'RT-NBI' },
                sectorCode:      { type: 'string', example: 'RETAIL', description: 'Sector (RETAIL, WHOLESALE, HORECA, …)' },
                orderDate:       { type: 'string', format: 'date' },
                postingDate:     { type: 'string', format: 'date', nullable: true },
              },
            },
            lines: {
              ...
              items: {
                type: 'object',
                required: ['lineNo', 'itemNo', 'description', 'quantity', 'unitPrice', 'lineAmount'],
                properties: {
                  lineNo:        { type: 'integer' },
                  itemNo:        { type: 'string' },
                  description:   { type: 'string' },
        ...
        WebhookInvoicePayload: {
          type: 'object',
          required: ['orderNo', 'invoiceNo', 'invoicedAt'],
          properties: {
            orderNo:        { type: 'string', example: 'SO-0001' },
            invoiceNo:      { type: 'string', example: 'INV-0001' },
            invoicedAt:     { type: 'string', format: 'date-time' },
