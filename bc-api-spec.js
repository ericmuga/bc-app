...
export const BC_API = {
  ...
  webhookOrder: {
    ...
    body: {
      header: {
        ...
        routeCode:        'string   optional  — Route Code (custom dimension / field)',
        sectorCode:       'string   optional  — Sector Code (RETAIL | WHOLESALE | HORECA)',
        orderDate:        'string   optional  — ISO 8601 date, e.g. "2025-03-16"',
        postingDate:      'string   optional  — ISO 8601 date, null if not yet posted',
        printingDatetime: 'string   optional  — ISO 8601 datetime when the document was printed in BC, e.g. "2025-03-16T08:45:00.000Z"',
      ...
      lines: [
        {
          ...
          lineAmount:    'number   REQUIRED  — Line Amount',
  ...
  webhookInvoice: {
     ...
     */
    body: {
      orderNo:          'string   REQUIRED  — Original Sales Order No. (must exist in app)',
      ...
      postingDate:      'string   optional  — ISO 8601 date of posting, e.g. "2025-03-16"',
      ...
      lines:            'array    optional  — Invoice lines (same shape as order lines); if omitted, order lines are carried over',
    },
